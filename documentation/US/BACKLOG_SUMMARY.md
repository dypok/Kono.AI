...
| **Dylan** | US-RUST-001, US-RUST-003 (part), US-PY-001, US-PY-003 (part) | **20.5 SP** | Rust Ingestion, Python Spatial Engine & API |
...
| **TOTAL** | **10 Historias de Usuario Jira-Ready** | **65 SP** | **Proyecto Completo End-to-End** |
